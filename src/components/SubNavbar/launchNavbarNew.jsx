...
const LaunchNavBarNew = ({ mode }) => {
    ...
    return (
        <>
            <Navbar className="p-0 m-0 body bg_white navStack1" expand="lg">
                <Container style={{ margin: "0px", padding: "0px" }} className="">
                    ...
                    <Navbar id="basic-avbar-nav" >
                        <Nav className="me-5">
                            ...
                            {/* <div> */}
                            <Nav.Link className="resource_origin2" style={{ msrginRight: "15em" }}>
                                <div
                                    className="color_black resource_origin2"
                            ...
                            <div
                                className="resource_toggle2 space-y-20 p-3"
                                style={{
                                    textDecoration: "none"
                                }}
                                id="dfsa"
                ...
                <span className="text-center">2.45 <strong>ETH</strong> </span>
                            ...
                            <div
                                className="avatar_popup avatar_Toggle space-y-20 p-3"
                                // style={{
                    ...
                    <div className="header__bs  wallet_hader">
                        <Link
                            to="/walletconnect"
                            className="bg-hite"
                            style={{ cursor: "pointer" }}
              ...
              <Button variant="primary" onClick={handleClose}>
                Save Changes
                    ...
                    : null}
                <Offcanvas id="dfsa myOffcanvas" style={{ width: "70%", height: "auto" }} className="body offcanvas" show={show1} onHide={handleClose1}>
...
export default LaunchNavBarNew;
