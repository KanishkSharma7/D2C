  ...
  return (
    ...
    <div className="hero__upload">
      ...
      <div className="">
              ...
              <p className="sp-bottom al-center  text-white">Set a period of time for which buyers can place bids</p>
      </div>
          ...
          <div className="col-lg-6">
            <div className="form-group space-y-10">
              <div className="space-y-20">
                ...
                <div className="space-y-10">
                  <span className="variationInput">Minimum Bid</span>
                  <input
                    type="text"
                ...
                <div className='row'>
                    <div className='col'>
                    <div className="space-y-10">
                  <span className="variationInput">Starting Date</span>
                  <input
                    type="date"
                    className="form-select custom-select"
                    aria-label="Default select example"
                  ...
                  />
                    ...
                    <div className='col'>
                    <div className="space-y-10">
                  <span className="variationInput">Expiration Date</span>
                  <input
                    type="date"
                    className="form-select custom-select"
                    aria-label="Default select example"
            ...
            <button
              ...
              className="btn btn-primary btn-md btn-upload"
            >
              Create Auction
            </button>
          </div>
